...
def get_sales_data():
    ...
    Runs a while loop to continually request valid data from the user.
    The loop will run until valid data is provided.
    """
    while True:
...
def get_last_5_entries_sales():
    """
    Collects column data from sales worksheet, collecting
